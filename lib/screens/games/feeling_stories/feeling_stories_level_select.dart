...
import 'feeling_stories_game.dart';

class FeelingStoriesLevelSelect extends StatelessWidget {
  final String userId;
  const FeelingStoriesLevelSelect({super.key, required this.userId});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Feeling Stories'),
      ),
      body: SafeArea(
        child: Padding(
            ...
            children: [
              ...
              _LevelButton(
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => FeelingStoriesGame(level: 1, userId: userId))),
              ),
              const SizedBox(height: 12),

              _LevelButton(
                label: 'Medium',
                subtitle: 'Social situations',
                badge: 'Level 2',
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => FeelingStoriesGame(level: 2, userId: userId))),
              ),
              const SizedBox(height: 12),

              _LevelButton(
                label: 'Hard',
                subtitle: 'Complex feelings',
                badge: 'Level 3',
                ...
                onTap: () => Navigator.push(context, MaterialPageRoute(
                    builder: (_) => FeelingStoriesGame(level: 3, userId: userId))),
              ),
