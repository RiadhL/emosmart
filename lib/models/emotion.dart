class Emotion {
  ...
  static const List<Emotion> hard = [
    ...
    Emotion(id: 'guilty',       name: 'Guilty',       emoji: '😣', description: 'Feeling bad about something done.',  level: 'hard'),
    Emotion(id: 'worried',      name: 'Worried',      emoji: '😟', description: 'Feeling anxious about something.',   level: 'hard'),
